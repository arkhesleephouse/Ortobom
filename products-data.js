...
const PRODUCTS = [
  ...
  {id:"orion", name:"Orion", category:"colchoes", line:"Linha Ouro",
   ...
   price:4499, priceNote:"Casal", images:[{url:"orion.jpg", label:"Padrão"}, {url:"orion-detail.jpg", label:"Detalhe"}]},
  {id:"bellona", name:"Bellona", category:"colchoes", line:"Linha Ouro",
   ...
   price:3599, priceNote:"Casal", images:[{url:"bellona.jpg", label:"Padrão"}, {url:"bellona-detail.jpg", label:"Detalhe"}]},
  {id:"orthopur", name:"Orthopur", category:"colchoes", line:"Linha Ouro",
   ...
   price:4899, priceNote:"Casal", images:[{url:"orthopur.jpg", label:"Padrão"}, {url:"orthopur-detail.jpg", label:"Detalhe"}]},
  {id:"liberty", name:"Liberty", category:"colchoes", line:"Linha Ouro",
   desc:"Fibra sustentável feita de garrafas PET recicladas.",
   price:3199, priceNote:"Casal", images:[{url:"liberty.jpg", label:"Padrão"}, {url:"liberty-detail.jpg", label:"Detalhe"}]},
  {id:"pro-forca", name:"Pró Força", category:"colchoes", line:"Linha Ouro",
   ...
   price:null, images:[{url:"pro-forca.jpg", label:"Padrão"}, {url:"pro-forca-detail.jpg", label:"Ambiente"}]},
  {id:"absolut-hybrid", name:"Absolut Hybrid", category:"colchoes", line:"Linha Ouro",
   ...
   price:3299, priceNote:"Casal", images:[{url:"absolut-hybrid.jpg", label:"Padrão"}, {url:"absolut-hybrid-detail.jpg", label:"Detalhe"}]},
  {id:"ouro-spring", name:"Ouro Spring", category:"colchoes", line:"Linha Ouro",
   desc:"Molas de fio contínuo com resistência progressiva.",
   price:2719, priceNote:"Casal", images:[{url:"ouro-spring.jpg", label:"Padrão"}, {url:"ouro-spring-detail.jpg", label:"Ambiente"}]},
  {id:"ortopedico-premium", name:"Ortopédico Premium", category:"colchoes", line:"Linha Ouro",
   ...
   price:2749, priceNote:"Casal", images:[{url:"ortopedico-premium.jpg", label:"Padrão"}, {url:"ortopedico-premium-detail.jpg", label:"Outro ângulo"}]},
  ...
  {id:"pro-saude-superpocket", name:"Pró Saúde Superpocket", category:"colchoes", line:"Pró Saúde",
   ...
   price:1169, priceNote:"Solteiro", images:[{url:"pro-saude-superpocket.jpg", label:"Padrão"}, {url:"pro-saude-superpocket-detail.jpg", label:"Detalhe"}]},
  {id:"pro-saude-nanolastic", name:"Pró Saúde Nanolastic", category:"colchoes", line:"Pró Saúde",
   ...
   price:1499, priceNote:"Casal", images:[{url:"pro-saude-nanolastic.jpg", label:"Padrão"}, {url:"pro-saude-nanolastic-detail.jpg", label:"Ambiente"}]},
  ...
  {id:"pro-saude-ortopedico", name:"Pró Saúde Ortopédico", category:"colchoes", line:"Pró Saúde",
   ...
   price:1619, priceNote:"Casal", images:[{url:"pro-saude-ortopedico.jpg", label:"Padrão"}, {url:"pro-saude-ortopedico-detail.jpg", label:"Detalhe"}]},
  ...
  {id:"fashion-superpocket", name:"Fashion Superpocket", category:"colchoes", line:"Fashion",
   ...
   price:1339, priceNote:"Casal", images:[{url:"fashion-superpocket.jpg", label:"Padrão"}, {url:"fashion-superpocket-detail.jpg", label:"Ambiente"}]},
  {id:"fashion-nanolastic", name:"Fashion Nanolastic", category:"colchoes", line:"Fashion",
   ...
   price:1119, priceNote:"Casal", images:[{url:"fashion-nanolastic.jpg", label:"Padrão"}, {url:"fashion-nanolastic-detail.jpg", label:"Ambiente"}]},
  {id:"fashion-firm", name:"Fashion Firm", category:"colchoes", line:"Fashion",
   desc:"Firmeza equilibrada com reforço lateral em PU.",
   price:749, priceNote:"Casal", images:[{url:"fashion-firm.jpg", label:"Padrão"}, {url:"fashion-firm-detail.jpg", label:"Ambiente"}]},
  ...
  {id:"almofada-rolete-camurca", name:"Almofada Rolete Camurça", category:"acessorios", line:"Uso Avulso",
   ...
   price:null, images:[{url:"almofada-rolete-camurca-brown.jpg", label:"Padrão"}]},
  ...
  {id:"base-sommier-bau-fashion-cori", name:"Base Sommier Baú Fashion Cori", category:"bases",
   ...
   price:2299, priceNote:"Queen", images:[{url:"base-sommier-bau-fashion-cori-black.jpg", label:"Preto"}, {url:"base-sommier-bau-fashion-cori-gray.jpg", label:"Cinza"}]},
  ...
  {id:"base-sommier-bau", name:"Base Sommier Baú", category:"bases",
   ...
   price:null, images:[{url:"base-sommier-bau-gray.jpg", label:"Cinza"}]},
  {id:"base-sommier-bau-bi-cori", name:"Base Sommier Baú Bipartido Cori", category:"bases",
   ...
   price:null, images:[{url:"base-sommier-bau-bi-cori-black.jpg", label:"Preto"}, {url:"base-sommier-bau-bi-cori-gray.jpg", label:"Cinza"}, {url:"base-sommier-bau-bi-cori-white.jpg", label:"Branco"}, {url:"base-sommier-bau-bi-cori-brown.jpg", label:"Marrom"}]},
  {id:"base-sommier-bau-bi-nobuck", name:"Base Sommier Baú Bipartido Nobuck", category:"bases",
   ...
   price:null, images:[{url:"base-sommier-bau-bi-nobuck-gray.jpg", label:"Cinza"}, {url:"base-sommier-bau-bi-nobuck-black.jpg", label:"Preto"}]},
  {id:"base-sommier-cori", name:"Base Sommier Cori", category:"bases",
   desc:"Base com acabamento Cori, disponível em várias cores.",
   price:null, images:[{url:"base-sommier-cori-white.jpg", label:"Branco"}, {url:"base-sommier-cori-black.jpg", label:"Preto"}]},
  ...
  {id:"cabeceira-cherie", name:"Cabeceira Cherie", category:"cabeceiras",
   ...
   price:459, priceNote:"Casal", images:[{url:"cabeceira-cherie.jpg", label:"Padrão"}]},
  {id:"cabeceira-glamour", name:"Cabeceira Glamour", category:"cabeceiras",
   desc:"Cabeceira estofada em linho, acabamento sofisticado.",
   price:499, priceNote:"Casal", images:[{url:"cabeceira-glamour.jpg", label:"Padrão"}]},
  ...
  {id:"poltrona-massageadora-relax", name:"Poltrona Massageadora Relax", category:"moveis",
   ...
   price:3499, images:[{url:"poltrona-massageadora-relax.jpg", label:"Padrão"}]},
  ...
  {id:"travesseiro-king-premium", name:"Travesseiro King Premium", category:"travesseiros",
   ...
   price:299, images:[{url:"travesseiro-king-premium.jpg", label:"Padrão"}]},
  {id:"travesseiro-pluma-ganso", name:"Travesseiro Pluma de Ganso", category:"travesseiros",
   ...
   price:599, images:[{url:"travesseiro-pluma-ganso.jpg", label:"Padrão"}]},
  {id:"travesseiro-pro-latex-gel", name:"Travesseiro Pró Látex Gel", category:"travesseiros",
   ...
   price:549, images:[{url:"travesseiro-pro-latex-gel.jpg", label:"Padrão"}]},
  {id:"travesseiro-sonho", name:"Travesseiro Sonho", category:"travesseiros",
   ...
   price:119, images:[{url:"travesseiro-sonho.jpg", label:"Padrão"}]},
